...
export default function NationwideMapPanel({ data, selectedSido, selectedDistrict, mapLevel, onSelectSido, onSelectDistrict, onShowNationwide }) {
  ...
  return <section className="panel nationwide-map-panel">
    ...
    <PolicyGeoMap data={data} mapLevel={mapLevel} selectedSido={selectedSido} selectedDistrict={selectedDistrict} onSelectSido={onSelectSido} onSelectDistrict={onSelectDistrict} />
    <div className="map-legend-readable"><span>취약도</span><i className="legend-stable" /><b>안정</b><i className="legend-watch" /><b>관찰</b><i className="legend-critical" /><b>취약</b><span className="legend-caption">색상: 편의점 중심 소비 비율 · BC카드 20대</span></div>
